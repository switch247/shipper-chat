...
export function GlobalSidebar() {
  ...
  return (
    <aside className="w-20 bg-white border-r border-gray-200 flex flex-col items-center justify-between py-6 shrink-0 z-50">
      {/* Top Section */}
      <div className="flex flex-col items-center gap-8 w-full">
        {/* Logo */}
        <Link href="/chat" className="w-12 h-12 rounded-xl bg-primary flex items-center justify-center text-primary-foreground shadow-lg shadow-primary/20 transition-transform active:scale-95 group">
